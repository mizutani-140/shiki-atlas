...
- **[code-review](./code-review/SKILL.md)** — Mandatory pre-PR self-review gate: review the task diff after TDD green, apply fixes on the task branch, and record ledger + PR body evidence.
